...
The analysis is meant to be applied to per-allele read counts observed at a number of polymorphic sites, as can typically be obtained from NGS reads alignments. The analysis also needs pre-acquired and independent estimates of allele frequencies in each subpopulation and at each site.
